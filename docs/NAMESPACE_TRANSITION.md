...
> Audience: Salesforce reviewers, Strategic Partners, and Comms Cloud implementation teams.
...
| `kyocera-comms` | `Catalog__c` (9), `ObjectClass__c` (98) | `ProductCatalog` (1), `ProductCategory` (1), `AttributeDefinition` (7) | Hybrid |
...
*This document is a working draft. We welcome corrections, additions, and
clarifications — particularly from anyone closer to the official
Salesforce roadmap than we are. See the project [LICENSE](../LICENSE) for
distribution terms.*
